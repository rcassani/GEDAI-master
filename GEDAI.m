...
if exist('samples_to_keep', 'var')
    ...
    if visualize_artifacts && ~isempty(refCOV)
        ...
        visualization_metrics = SENSAI_visualization(EEGavRef, EEGclean, EEGartifacts, refCOV, sensai_epoch_size, signal_type, vis_pcs, artifact_threshold_type, smoothing_window_seconds);
